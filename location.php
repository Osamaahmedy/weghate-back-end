...
echo "success : ";
    ...
    $insertQuery = "INSERT INTO `opar` (firstName, lastName, phoneNumber, vip, email, age, uniqueId, latitude, longitude, car, bus, locationLink, location) 
                    VALUES ('$firstName', '$lastName', '$phoneNumber', '$vip', '$email', '$age', '$uniqueId', '$latitude', '$longitude', '$car', '$bus', '$locationLink', '$location')";
    $insert = mysqli_query($conn, $insertQuery);
    
    if ($insert) {
        // إنشاء كود QR
        $qrData = "Name: $firstName $lastName\nPhone: $phoneNumber\nEmail: $email\nUnique ID: $uniqueId\nAge: $age\nlatitude: $latitude\nlongitude: $longitude\ncar: $car\nvip: $vip\nbus :$bus\nYour location :$locationLink\nWhere you go  :$location";
        ...
        $pdf->Cell(0, 50, ' Uber Driver Services ', 0, 1, 'C');
        $pdf->Ln(5);
        // اسم ورقم
...
$pdf->Image($newQrFile, $x, $y, $imageWidth, $imageHeight);
        ...
        // إخراج ملف PDF
        $pdfFile = 'Uber_Driver_Services.pdf';
        ...
        try {
            ...
            $mail->setFrom('your-email@gmail.com', 'Uber Driver Services ');
            $mail->addAddress($email);
            $mail->isHTML(true);
            $mail->Subject = 'Uber Driver  Confirmation';
            $mail->Body = "
            <h1>Uber Driver Services </h1>
            <p>Name: $firstName $lastName</p>
            <p>Email: $email</p>
             <p> Where you go location: $location</p>
        ...
        ";
            ...
            $mail->Subject = ' New Uber Driver Services  Request';
            $mail->Body = "
            <h1>Uber Driver Services </h1>
            <p>Name: $firstName $lastName</p>
            <p>Email: $email</p>
              <p>Where he go location: $location</p>
            <p> There Location: <a href='$locationLink'>View on Google Maps</a></p>
        ";
